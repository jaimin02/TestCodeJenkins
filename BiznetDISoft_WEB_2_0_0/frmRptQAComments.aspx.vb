...
Partial Class frmRptQAComments
...
#Region "GenCallShowUI "
    ...
    Private Function GenCallShowUI() As Boolean
        ...
        Try
            ...
            CType(Me.Master.FindControl("lblHeading"), Label).Text = "QC Comments Report"
...
#Region "Report Helper Functions"
    ...
    Private Sub ReportHeader()
        ...
        rCell.Value = "QC Comments Report"
        rCell.Alignment = RepoCell.AlignmentEnum.CenterMiddle
        rCell.FontBold = True
        rCell.FontSize = 12
        rCell.FontColor = Drawing.Color.Maroon
...
#Region " GetData "
    Private Function GetData(ByRef dt_Report_Retu As DataTable) As Boolean
        ...
        Try
            ...
            wStr = "cast(convert(varchar(11),dQCGivenOn,113)as smalldatetime)>=cast(convert(varchar(11),cast('" & FromDate & "' as datetime),113)as smalldatetime) And cast(convert(varchar(11),dQCGivenOn,113)as smalldatetime)<= cast(convert(varchar(11),cast('" & ToDate & "' as datetime),113)as smalldatetime) and cIsSourceDocComment<>'Y'"
            ...
            ElseIf Me.RblCommentsOn.SelectedValue.ToUpper.Trim() = "MSR" Then
                ...
                wStr += " And cIsSourceDocComment <> 'Y' "
