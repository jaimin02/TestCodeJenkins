...
function isInArray(a, b) {
        ...
        a.JQPlugin.createPlugin({
            ...
            _calculatePeriods: function(a, b, j, k) {
                ...
                if (b[c] || b[d]) {
                    ...
                    m[c] = b[c] ? Math.floor(r / 12) : 0, m[d] = b[d] ? r - 12 * m[c] : 0,
    ...
    function() {
        ...
        function b(a) {
            this.element = a, this.Adapter = e.Adapter, this.adapter = new this.Adapter(a), this.key = "waypoint-context-" + c, this.didScroll = !1,
                this.didResize = !1, this.oldScroll = {
                    ...
                    if (e(this.yLabels, function(b, c) {
                            if (c > 0) {
                                var d, e = c * (this.drawingArea / this.steps),
                                    f = this.yCenter - e;
                                if (this.lineWidth > 0)
                                    if (a.strokeStyle = this.lineColor, a.lineWidth = this.lineWidth, this.lineArc) a.beginPath(), a.arc(this.xCenter, this.yCenter, e, 0, 2 * Math.PI),
...
var pJS = function(a, b) {
    ...
    b && Object.deepExtend(d, b), d.tmp.obj = {
        ...
        if (this.radius = (d.particles.size.random ? Math.random() : 1) * d.particles.size.value, d.particles.size.anim.enable && (this.size_status = !1, this.vs = d.particles.size.anim.speed / 100, d.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = c ? c.x : Math.random() * d.canvas.w, this.y = c ? c.y : Math.random() * d.canvas.h, this.x > d.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius),
            this.y > d.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), d.particles.move.bounce && d.fn.vendors.checkOverlap(this, c), this.color = {}, "object" == typeof a.value)
...
Object.deepExtend = function(a, b) {
        ...
        f.className = d, f.style.width = "100%";
    ...
    function(a, b, c) {
        ...
        d.prototype.refresh = function(a) {
            var d, e, f = !1;
            for (a === c ? (f = !0, fa = [], Ia = 0, a = b.getElementsByTagName("*")) : a = [].concat(a), d = 0, e = a.length; d < e; d++) {
                var g = a[d],
                    h = g,
                    i = [],
                    j = la,
        ...
        var U = function() {
                    ...
                    switch (h = e.clientY, j = e.clientX, r = a.timeStamp, a.type) {
                        ...
                        case n:
                            var f = d - h,
                                u = g - j,
                                v = u * u + f * f;
                            if (v < 49) return b.focus(), void b.click();
                            b = c;
                            var w = p / t;
                            w = i.max(i.min(w, 3), -3);
                            var x = i.abs(w / y),
                                ...
                                A = ea.getScrollTop() - z,
                                B = 0;
                            A > Aa ? (B = (Aa - A) / z, A = Aa) : A < 0 && (B = -A / z, A = 0), x *= 1 - B, ea.animateTo(A, {
                                easing: "outCubic",
                                duration: x
                            })
                    }
            ...
            V = function() {
                ...
                for (h = 0, j = fa.length; h < j; h++)
                    for (a = fa[h], b = a.element, c = a.anchorTarget, d = a.keyFrames, e = 0, f = d.length; e < f; e++) g = d[e], "relative" === g.mode && (ca(b), g.frame = ea.relativeToAbsolute(c, g.anchors[0], g.anchors[1]) - g.offset, ca(b, !0)), ia && !g.isEnd && g.frame > Aa && (Aa = g.frame);
                for (Aa = i.max(Aa, ta()), h = 0, j = fa.length; h < j; h++) {
                    for (a = fa[h], d = a.keyFrames, e = 0, f = d.length; e < f; e++) g = d[e], g.isEnd && (g.frame = Aa - g.offset);
                    a.keyFrames.sort(za)
                }
            },
            W = function(a, b) {
                for (var c = 0, d = fa.length; c < d; c++) {
                    var e, f, i = fa[c],
                        ...
                        u = l[s ? 0 : l.length - 1];
                    if (s || t) {
                        if (s && i.edge === -1 || t && 1 === i.edge) continue;
            ...
            $ = function(a) {
                var b, c, d = {};
                for (b = 0, c = a.keyFrames.length; b < c; b++) _(a.keyFrames[b], d);
            ...
            ca = function(a, b) {
                a = [].concat(a);
                for (var c, d, e = 0, f = a.length; e < f; e++) d = a[e], c = fa[d[E]], c && (b ? (d.style.cssText = c.dirtyStyleAttr, va(d, c.dirtyClassAttr)) : (c.dirtyStyleAttr = d.style.cssText, c.dirtyClassAttr = ua(d), d.style.cssText = c.styleAttr, va(d, c.classAttr)))
            },
            da = function() {
        ...
        var ea, fa, ga, ha, ia, ja, ka, la, ma, na, oa, pa, qa, ra = g.addEvent = function(b, c, d) {
            ...
            va = function(b, d, e) {
                ...
                for (var g = b[f], h = 0, i = e.length; h < i; h++) g = xa(g).replace(xa(e[h]), " ");
                g = wa(g);
                for (var j = 0, k = d.length; j < k; j++) xa(g).indexOf(xa(d[j])) === -1 && (g += " " + d[j]);
                b[f] = wa(g)
            },
            wa = function(a) {
                return a.replace(F, "")
            ...
            if (this.$element.trigger(j), !j.isDefaultPrevented()) {
                ...
                if (a.support.transition && this.$element.hasClass("slide")) {
                    ...
                    n = setTimeout(function() {
                        qodef.modules.shortcodes.qodefCheckSliderForHeaderStyle(e, m), e.addClass(b), e[0].offsetWidth, d.addClass(g), e.addClass(g), d.one("bsTransitionEnd", function() {
    ...
    function(a) {
        ...
        a.widget("ui.mouse", {
            ...
            _mouseDown: function(b) {
                if (!d) {
                    ...
                    return !(e && !f && this._mouseCapture(b)) || (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function() {
                        ...
                        return c._mouseUp(a)
                    }, this.document.on("mousemove." + this.widgetName, this._mouseMoveDelegate).on("mouseup." + this.widgetName, this._mouseUpDelegate), b.preventDefault(), d = !0, !0))
                }
            },
            ...
            _mouseUp: function(b) {
                this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, b.target === this._mouseDownEvent.target && a.data(b.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(b)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, d = !1, b.preventDefault()
            },
