...
Partial Class frmClinicalTrialData
...
#Region "VARIABLE DECLARATION "
    ...
    Private Const GVCWorkspace_SiteName As Integer = 1
    Private Const GVCWorkspace_PatientDetails As Integer = 2
    Private Const GVCWorkspace_WorkspaceId As Integer = 3

    Private Const GVCSubject_SrNo As Integer = 0
    Private Const GVCSubject_MySubjectNo As Integer = 1
    Private Const GVCSubject_Initial As Integer = 2
    Private Const GVCSubject_SubjectId As Integer = 3
    Private Const GVCSubject_SubjectName As Integer = 4
    Private Const GVCSubject_RegistrationDate As Integer = 5
    Private Const GVCSubject_Visits As Integer = 6
...
#Region "GenCall_ShowUI"
    ...
    Private Function GenCall_ShowUI() As Boolean
        ...
        Try
            Page.Title = " :: Clinical Trial Data ::  " + System.Configuration.ConfigurationManager.AppSettings("Client")
            CType(Me.Master.FindControl("lblerrormsg"), Label).Text = ""

            CType(Master.FindControl("lblHeading"), Label).Text = "Clinical Trial Data"
...
#Region "Fill Functions"
    ...
    Private Function FillGridWorkspaceSubject() As Boolean
        ...
        Try
            ...
            If Not objHelp.View_ProjectgroupWorkspaceSubject(wStr, WS_HelpDbTable.DataRetrievalModeEnum.DataTable_WithWhereCondition, _
...
#Region "Grid Event"
    ...
    Protected Sub gvWorkspaceSubject_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles gvWorkspaceSubject.RowEditing
        e.Cancel = True
    End Sub
