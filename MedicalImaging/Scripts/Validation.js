...
function blankCheck(Field) {
    ...
    //    if ((value.value.charAt(i) != ' ') && (value.value.charAt(i) != " ") && (value.value.charAt(i) != "\t") && (value.value.charAt(i) != "\r") && (value.value.charAt(i) != "\n")) {
    //    }
    //    else {
    //        return true;
    //    }        
...
//-------------------------------------------------------------------
// check for blank value for Drop Down
// Returns true if the value is blank.
//-------------------------------------------------------------------
function ddlBlankCheck(Field) {
    var value = document.getElementById(Field)
