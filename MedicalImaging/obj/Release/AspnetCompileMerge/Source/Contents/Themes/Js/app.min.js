...
$(function () {
  ...
  var link = $("<a />", { href: "http://www.sarjen.com/" })
    .html("Welcome to Diagnostics Imaging!")
    .css(link_css)
    .hover(function () {
  ...
  var btn = $("<a />", { "class": "btn btn-default btn-sm", href: "http://www.sarjen.com/" }).html("Let's Do It!").css(btn_css);
  var close = $("<a />", {
    "class": "pull-right",
    href: "#",
    "data-toggle": "tooltip",
