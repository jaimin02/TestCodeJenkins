...
function CheckValidation() {
    ...
    if (Newpwd == "") {
        ...
        if (Newpwd.length < Password_Minlen) {
            ...
            if (resAlhpa == "false" && resChar == "false") { } else {
                $("#NpwdErrmsg").html('');
                $("#NpwdErrmsg").html('Password Must Contain Atleast One Alphabet [a-z].\nPassword Must Contain Atleast One Digit [0-9].');
                return false;
            }
        }
    }
        ...
        if (ConfNewpwd.length < Password_Minlen) {
            ...
            if (Newpwd != "") {
                if (Newpwd != ConfNewpwd) {
                    ...
                    if (resAlhpa == "false" && resChar == "false") { } else {
                        $("#CofNpwdErrmsg").html('');
                        $("#CofNpwdErrmsg").html('Password Must Contain Atleast One Alphabet [a-z].Password Must Contain Atleast One Digit [0-9].');
                        return false;
                    }
                }
            }
