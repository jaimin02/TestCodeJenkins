...
$(function () {
    ...
    document.getElementById("ddlStatus").tabIndex = 2;
...
function getUserWiseProjectDetail() {
    ...
    $("#spanSkip").empty();
    $("#btnSkip").hide();
    var contextKeyVal = "  iUserid =" + $("#hdnuserid").val(); //cApprovedSite='Y' AND
    ...
    if (jsonData.responseText != "") {
        ...
        if (jsonData.length > 0) {
            ...
            var otable = $("#tblSubjectReviewList").dataTable({
                ...
                "aoColumns": columns,
                "columnDefs": [
                     { "targets": [0, 1, 9, 10], "visible": false, "searchable": false }
