<%@ page language="VB" autoeventwireup="false" inherits="frmArchiveCTMMedExInfoHdrDtl, App_Web_xbhimv2u" validaterequest="false" enableeventvalidation="false" theme="StyleBlue" viewStateEncryptionMode="Always" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        //                {
        //                    alert('Out Of Range! Value Must be Less Then ' + HighRange);
        //                    txt.style.borderColor = "Red";
        //                    if (txt.value.toUpperCase() == PreviousValue.toUpperCase() && BtnUpdateId != null)
        //                    {
        //                        return;
        ...
        //                {
        //                    alert('Out Of Range! Value Must be Greater Then ' + LowRange);
        //                    txt.style.borderColor = "Red";
        //                    if (txt.value.toUpperCase() == PreviousValue.toUpperCase() && BtnUpdateId != null)
        //                    {
        //                        return;
        ...
        //                {
        //                    alert('Length Exceeded! Lengh Should be Less Then Or Equal To ' + length);
        //                    txt.style.borderColor = "Red";
        //                    if (txt.value.toUpperCase() == PreviousValue.toUpperCase() && BtnUpdateId != null)
        //                    {
        //                        return;
        ...
        //            {
        //                alert('Please Enter Valid Temperature in Fahrenheit.');
        //                txtFahrenheit.focus();
        ...
        //            {
        //                alert('Select the check box and then click on OK.');
        //                return false;
        //            }
        ...
        <div align="center">
            <center>
                ...
                <table border="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111"
                    ...
                    <tr height="65">
                        <td style="vertical-align: bottom; width: 1000; height: 65; background-image: url(images/topheader.jpg); background-repeat: no-repeat;"
                            align="left">
                            <div align="right">
                                <table width="45%" border="0" align="right">
                                    <tr>
                                        <td style="white-space: nowrap">
                                            <asp:label id="lblWelcome" runat="server" cssclass="Label" text="Welcome, " forecolor="#FFffff"></asp:label>
                                            <asp:label
                                        ...
                                        <asp:label id="lblLoginTime1" runat="server" cssclass="Label" text="Login Time: "
                                            ...
                                            <asp:label id="lblTime" runat="server" cssclass="Label"
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="text-align: left; white-space: nowrap;">
                                                                                                    <asp:DropDownList ID="ddlActivities" runat="server" CssClass="Label" style="color:Black ; " Font-Bold="true"
                                                                                                ...
                                                                                                <td style="text-align: left;" align="left">
                                                                                                    ...
                                                                                                    <asp:Button Visible="false" ID="btnShowquery" runat="server" Text="Show Queries"
                                                                                                        CssClass="btn btnnew" Width="100px" OnClientClick="return AnyDivShowHide('DIVQUERIESSHOW');">
                                                                                                    </asp:Button>
                                                                                                    <asp:Button Visible="false" ID="btnReviewHistory" runat="server" Text="Show Review History"
                                                                                                        CssClass="btn btnnew" Width="135px"></asp:Button>
                                                                                                    <%--</ContentTemplate>
                                                                                                        <Triggers>
                                                                                                ...
                                                                                                <td valign="top" align="left">
                                                                                                    <asp:UpdatePanel ID="UpPlaceHolder" runat="server">
                                                                                                        <ContentTemplate>
                                                                                                                                ...
                                                                                                                                <asp:Panel ID="pnlHistoryDtl" runat="server" Width="630px" ScrollBars="Auto" Height="220px">
                                                                                                                                    ...
                                                                                                                                    <asp:GridView ID="GVHistoryDtl" runat="server" AutoGenerateColumns="False" BorderColor="Peru"
                                                                                                                                        ...
                                                                                                                                        <Columns>
                                                                                                                                            ...
                                                                                                                                            <asp:BoundField DataField="dModifyOnSubDtl_IST" HeaderText="Modify On" DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}">
                                                                                                                                                <ItemStyle Wrap="False" />
                                                                                                                                            </asp:BoundField>
                                                                                                                                        </Columns>
                                                                                                                                    </asp:GridView>
                                                                                                                    ...
                                                                                                                    <tbody>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td style="text-align: left" align="right">
                                                                                                                                <asp:Button ID="btnSaveDiscrepancy" runat="server" Text="Add" CssClass="button" OnClientClick="return ValidationForDiscrepancy();">
                                                                                                                                </asp:Button>
                                                                                                            ...
                                                                                                            <asp:HiddenField ID="HFProjectLockStatus" runat="server"></asp:HiddenField>
                                                                                                            <asp:HiddenField ID="HFType" runat="server"></asp:HiddenField>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 50%; height: 13px" align="left">
                                            <asp:button id="BtnPrevious" runat="server" text="<< Previous" cssclass="btn btnnew"
                                                width="97px"></asp:button>
                                        </td>
                                        <td style="white-space: nowrap; height: 13px" class="Label" align="center">
                                            <%-- <asp:Button ID="btnSaveAndContinue" runat="server" Text="Save & Continue" CssClass="button"
                                                                                                        Width="107px" OnClientClick="return ValidationsForSave();"></asp:Button>&nbsp;
                                                                                                    <asp:Button ID="BtnSave" runat="server" Text="Submit" CssClass="button" OnClientClick="return ValidationsForSave();">
                                                                                                    </asp:Button>--%>
                                                                                                    &nbsp;<input id="BtnExit" class="button" onclick="closewindow();" type="button" value="Exit" />
                                        </td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr align="center">
                                                            <td class="Label" align="center" colspan="3">
                                                                ...
                                                                <img id="ImgPopUpCloseAuthentication" alt="Close" src="images/Sqclose.gif" style="position: relative; float: right;" />
                                                            </td>
                                                        </tr>
                                                        <tr style="height: 10px;">
                                                        </tr>
                                                        ...
                                                        <tr align="center">
                                                            <td align="right" class="Label" style="white-space: nowrap"></td>
                                                            <td>&nbsp;&nbsp
                                                            </td>
                                                            <td align="left" class="Label">
