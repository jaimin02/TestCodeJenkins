<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="frmEditChecksOperations, App_Web_22suyskz" enableEventValidation="false" theme="StyleBlue" viewStateEncryptionMode="Always" %>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="890px">
                            <tr>
                                ...
                                <td class="Label" style="text-align: left; white-space: nowrap;">
                                    <asp:TextBox ID="txtproject" runat="server" CssClass="textBox" Width="550px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td class="Label" style="text-align: left; white-space: nowrap;">
                                    <asp:DropDownList ID="ddlVisit" runat="server" CssClass="dropDownList">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr style="display: none">
                                ...
                                <td class="Label" style="white-space: nowrap; text-align: left">
                            ...
                            <tr>
                                ...
                                <td class="Label" style="text-align: left; white-space: nowrap;">
                                    <asp:Button ID="btnGo" runat="server" CssClass="btn btnnew" Text="Execute" OnClientClick="return Validation();" />
                                    ...
                                    <asp:Button ID="btnView" runat="server" CssClass="btn btnnew" Text="View" OnClientClick="return Validation();" />
                            ...
                            <asp:UpdatePanel ID="upGridHdr" runat="server" RenderMode="Inline" UpdateMode="Conditional"
                                ...
                                <ContentTemplate>
                                    <table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="text-align: left" class="Label" colspan="2">
                                                                    ...
                                                                    <div style="overflow: auto; max-height: 160px;" id="divHdr_Data" onscroll="OnscrollfnctionHdr();"
                                                                        runat="server">
                                                                        <asp:GridView ID="GVEditChecksHdr" runat="server" SkinID="grdViewSmlAutoSize" AutoGenerateColumns="False"
                                                                            CssClass="gvwProjects" EmptyDataText="No Queries found.">
                                                                            <Columns>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <asp:Button runat="server" ID="Btn_viewAll" Text="View All" CssClass="btn btnnew" Style="display: none;" />
                                            </td>
                                        </tr>
                                    </table>
                                </ContentTemplate>
                            ...
                            <asp:UpdatePanel ID="upGridDtl" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Panel runat="server" ID="pnlDtl" Width="950px">
                                                    <table align="center">
                                                        <tbody>
                                                            <%-- <tr>
                                                            ...
                                                            <tr>
                                                                <td style="white-space: nowrap; text-align: left" class="Label">
                                                                    <asp:Panel runat="server" ID="upDtl">
                                                                        ...
                                                                        <div id="divDtl_Data" onscroll="OnscrollfnctionDtl();" style="overflow: auto; max-width: 900px;
                                                                            max-height: 500px;" runat="server">
                                                            ...
                                                            <tr>
                                                                <td style="white-space: nowrap; text-align: center" class="Label" align="center"
                                                                    ...
                                                                    <div style="display: none; left: 391px; width: 300px; top: 528px; height: 180px;
                                                                        ...
                                                                        <asp:Panel ID="pnlGenerateQuery" runat="server" Width="300px" Height="180px" __designer:wfdid="w17">
                                                                            <table width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:TextBox ID="txtGenerateQueryRemarks" runat="server" Width="208px" Height="70px"
                                                                                                TextMode="MultiLine" __designer:wfdid="w18"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr height="6">
                                                                                        <td colspan="2">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="text-align: center" colspan="2">
                                                                                            <asp:Button ID="btndivGenerateQuery" class="btn btnnew" runat="server" Text="Generate"
                                                                                                OnClientClick="return ValidationForGenerateQuery();" __designer:wfdid="w19">
                                                                                            </asp:Button>
                                                            ...
                                                            <tr>
                                                                <td style="white-space: nowrap; text-align: center" class="Label" align="center"
                                                                    ...
                                                                    <div style="display: none; left: 391px; width: 300px; top: 528px; height: 180px;
                                                                        ...
                                                                        <asp:Panel ID="pnlResolveQuery" runat="server" Width="300px" Height="180px" __designer:wfdid="w20">
                                                                            <table width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="text-align: center" align="center" colspan="2">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:TextBox ID="txtResolveQueryRemarks" runat="server" Width="208px" Height="70px"
                                                                                                TextMode="MultiLine" __designer:wfdid="w21"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr height="6">
                                                                                        <td colspan="2">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="text-align: center" colspan="2">
                                                                                            <asp:Button ID="btndivResolveQuery" class="btn btnnew" runat="server" Text="Resolve"
                                                                                                OnClientClick="return ValidationForResolveQuery();" __designer:wfdid="w22"></asp:Button>&nbsp;<input
                                                                                                    id="btndivResolveQueryClose" class="button" onclick="return ResolveQueryDivShowHide('H','chkResolveQueryAll.ClientId');"
                                                                                                    type="button" value="Close" runat="server" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <asp:Button runat="server" ID="btnExportToExcell"  CssClass="btn btnexcel"
                                                    Style="display: none;" />
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="GVEditChecksHdr" EventName="RowCommand"></asp:AsyncPostBackTrigger>
                                    <asp:AsyncPostBackTrigger ControlID="btnCancel" EventName="Click" />
                                    <asp:AsyncPostBackTrigger ControlID="btnView" EventName="Click" />
