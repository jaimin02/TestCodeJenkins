...
function (a) {
    ...
    function i() {
        a(".qodef-section .qodef-video-wrap .qodef-video")
        //.mediaelementplayer({
        //enableKeyboard: !1,
    ...
    function q() {
        var b = a(".qodef-self-hosted-video");
    ...
    function x() {
        qodef.body.hasClass("qodef-smooth-page-transitions") && (a(window).bind("pageshow", function (b) {
            ...
            var c = a(this);
            1 == b.which && "undefined" == typeof c.data("rel") && "undefined" == typeof c.attr("rel") && c.attr("href").indexOf(window.location.host) >= 0 && ("undefined" == typeof c.attr("target") || "_self" === c.attr("target")) && c.attr("href").split("#")[0] !== window.location.href.split("#")[0] && (b.preventDefault(), a(".qodef-wrapper-inner").fadeOut(1e3, function () {
    ...
    var z = qodef.modules.common.qodefInitAnchor = function () {
        var b = function (b) {
            ...
            e = function (a) {
                "qodef-sticky-header-on-scroll-down-up" == qodef.modules.header.behaviour && (a > qodef.modules.header.stickyAppearAmount ? qodef.modules.header.isStickyVisible = !0 : qodef.modules.header.isStickyVisible = !1), "qodef-sticky-header-on-scroll-up" == qodef.modules.header.behaviour && (a > qodef.scroll ? qodef.modules.header.isStickyVisible = !1 : "");
                var b = qodef.modules.header.isStickyVisible ? qodefGlobalVars.vars.qodefStickyHeaderTransparencyHeight : qodefPerPageVars.vars.qodefHeaderTransparencyHeight;
                return b
            },
            f = function () {
...
function (a) {
    ...
    function e() {
        if (a("a.qodef-fullscreen-menu-opener").length) {
            ...
            d.height(qodef.windowHeight).niceScroll({
                ...
                return "http://#" !== a(this).attr("href") && "#" !== a(this).attr("href") && void (1 == d.which && (c.removeClass("opened"), qodef.body.removeClass("qodef-fullscreen-menu-opened"), qodef.body.removeClass("qodef-fullscreen-fade-in").addClass("qodef-fullscreen-fade-out"), qodef.body.addClass(b), a("nav.qodef-fullscreen-menu ul.sub_menu").slideUp(200, function () {
                    a("nav.popup_menu").getNiceScroll().resize()
    ...
    function h() {
        var b = a(".qodef-drop-down > ul > li.narrow");
        b.each(function (b) {
    ...
    function j() {
        ...
        var e, f, g = a("a.qodef-search-opener"),
            h = !1;
        if (a("html").hasClass("touch") && (h = !0), g.length > 0)
            if (qodef.body.hasClass("qodef-fullscreen-search")) {
                var i = !1,
                    j = !1;
                e = a(".qodef-fullscreen-search-close"), qodef.body.hasClass("qodef-search-fade") ? i = !0 : qodef.body.hasClass("qodef-search-from-circle") && (j = !0), d(i, j)
...
function (a) {
    ...
    function e() {
        ...
        b.length && b.each(function () {
            var b = a(this);
            b.find(".qodef-close").click(function (b) {
    ...
    function i() {
        ...
        b.length && b.each(function () {
            ...
            var e = 5e3,
                ...
                h = 600,
                i = "cards_carousel";
            "undefined" != typeof b.data("animation-speed") && b.data("animation-speed") !== !1 && (h = b.data("animation-speed")), "undefined" != typeof b.data("layout") && (i = b.data("layout")), "standard_carousel" == i && (f = !0), b.owlCarousel({
                singleItem: !0,
                autoPlay: e,
                addClassActive: !0,
                navigation: g,
    ...
    function j() {
        ...
        b.length && b.each(function () {
            ...
            var c = 5e3,
                ...
                e = !1,
                f = 600;
            "undefined" != typeof b.data("animation-speed") && b.data("animation-speed") !== !1 && (f = b.data("animation-speed")), b.owlCarousel({
                singleItem: !0,
                autoPlay: c,
                addClassActive: !0,
                navigation: e,
    ...
    function k() {
        ...
        e.length && e.each(function () {
            b = e.children(".qodef-carousel"), c = b.data("items"), d = "yes" == b.data("navigation");
            var a = [
                [0, 1],
                [480, 2],
                [768, 3],
    ...
    function l() {
        ...
        b.length && b.each(function () {
            var b = a(this),
                ...
                g = 145,
                h = c.data("bar-color");
            "undefined" != typeof h && (e = h);
            var i = c.data("bar-inactive-color");
            "undefined" != typeof i && (d = i);
            var j = c.data("size");
            "undefined" != typeof j && (g = j), c.appear(function () {
                m(b), c.css({
                    opacity: "1",
                    width: g + "px",
                    height: g + "px",
    ...
    function n() {
        var b = a(".qodef-pie-chart-doughnut-holder, .qodef-pie-chart-pie-holder");
        b.each(function () {
    ...
    function p() {
        ...
        b.length && b.each(function () {
            ...
            "undefined" != typeof e && e.children(".qodef-icon-frame").append(d)
        })
    }
    ...
    function y() {
        var b = a('.qodef-live-search-enabled input[type="text"]');
        b.each(function () {
            var b = a(this);
            b.focusin(function () {
                var c = b.offset().left,
    ...
    function z() {
        ...
        b.length && b.each(function () {
            var b = a(this);
            A(b), qodef.modules.common.qodefInitParallax()
        })
    }
